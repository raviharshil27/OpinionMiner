...
$.ajax({
        ...
        dataType: 'jsonp',
        data:'v=1.0&q='+ search_topic,
        success:
            function (images)
        {
            document.getElementById("object_image").setAttribute("src",images.responseData.results[0].url);
        }       
});
    //When page loads...
...
function getReviews(q)
{
    ...
    $.ajax({
     ...
     //         //   alert("get review" + pos);
                  setTwtTracker(search_topic);
        setFeatureTracker(search_topic);
